            ...
            submitHandler: function(form) {
                ...
                $.ajax({
                    ...
                    error: function() {
                        ...
                        sLoader.slideUp("slow"); 
                        $('.message-warning').html("Coś poszło nie tak, spróbuj jeszcze raz.");
                        $('.message-warning').slideDown("slow");
    ...
    * ------------------------------------------------------ */
    var clAjaxChimp = function() {
        ...
        $.ajaxChimp.translations.es = {
            'submit': 'Wysyłam...',
            0: '<i class="fa fa-check"></i> Wysłaliśmy potwierdzenie na Twój adres e-mail.',
            1: '<i class="fa fa-warning"></i> Proszę wprowadzić poprawny adres e-mail.',
